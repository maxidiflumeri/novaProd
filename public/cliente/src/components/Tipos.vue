  ...
  <div class="container-fluid mt-3">  
    ...
    <div v-else>  
      <md-table class="color" v-model="buscados" md-sort="name" md-sort-order="asc" md-card md-fixed-header @md-selected="onSelect">
        <md-table-toolbar>
          <div class="md-toolbar-section-start">
            <h1 class="md-title colorTitulo">Tipos de Productos</h1>
          </div>

          <md-field md-clearable class="md-toolbar-section-end">
            <md-input class = "text-primary" placeholder="Buscar Tipo..." v-model="busqueda" @input="buscarEnTabla" />
          </md-field>
        </md-table-toolbar>

        <md-table-empty-state
          md-label="No hay tipos de productos" >        
        </md-table-empty-state>
      ...
      <div class="mt-3 d-flex justify-content-center">
        <md-button class="md-fab bg-success md-mini" @click="getTipos()">
    ...
    <div class="mt-3 d-flex justify-content-center">     
      <form v-if="estaSeleccionado" class="md-layout">
        <md-card :class="claseCard">
          <md-card-header>
            <div class="md-title d-flex justify-content-center">TIPO DE PRODUCTO</div>
          </md-card-header>
          <md-card-content>
              ...
              <div class="container">
                <div class="row">
                  <div class="col-lg-6">
                    <md-field>
                      <label>Id Tipo</label>
                      <md-input name="id_tipo" id="id_tipo" v-model="seleccionadoTemp.id_tipo" disabled />
                    </md-field>
                  </div>
                  <div class="col-lg-6">
                    <md-field>
